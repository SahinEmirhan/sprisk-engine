...
/**
 * IP velocity detection rule
 * - measures request rate per IP address
 * - high frequency implies suspicious behaviour and produces a risk score
 */
public class IpVelocityRule implements ConfigurableRiskRule {
    ...
    public IpVelocityRule(WindowManager windowManager,
                          long windowSeconds,
                          long maxPerWindow,
                          int riskScore,
    ...
    public int evaluate(RiskContext ctx, Map<String, String> properties) {
        ...
        String key = "sprisk:velocity:ip:" + ip;
    ...
    private long readLong(Map<String, String> props, long fallback, String... keys) {
        for (String key : keys) {
            ...
            try {
                ...
                System.out.println("[IpVelocityRule] Invalid long for " + key + ": " + value);
            }
        }
        return fallback;
    }
    ...
    private int readInt(Map<String, String> props, int fallback, String... keys) {
        for (String key : keys) {
            ...
            try {
                ...
                System.out.println("[IpVelocityRule] Invalid int for " + key + ": " + value);
            }
        }
        return fallback;
    }
